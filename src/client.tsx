...
const App: React.FC = () => {
  ...
  return (
    <AppContainer>
      ...
      <Footer>
        <strong>made with <span className="heart">❤️</span> in SF<span className="bridge">🌉</span> w/ <span className="cloudflare-ref">Cloudflare AutoRAG && Durable Objects</span>. Code on GitHub here</strong>
      </Footer>
    </AppContainer>
  );
};
